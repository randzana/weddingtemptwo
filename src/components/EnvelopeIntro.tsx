    ...
    <div ref={screenRef} className="envelope-screen">
      ...
      <div className="absolute top-[12%] left-1/2 -translate-x-1/2 text-center z-10 sm:top-[15%]">
        <p
          ...
          style={{ fontFamily: "var(--font-doran)", color: "#fdfaf2", textShadow: "0 2px 4px rgba(0,0,0,0.5)" }}
        >
          <br />
          <br />
          <br />
        ...
        >
          دییە{" "}
          <span className="text-3xl sm:text-4xl md:text-5xl italic" style={{ color: "#fdfaf2", textShadow: "0 2px 4px rgba(0,0,0,0.5)" }}>
            و
          </span>{" "}
          کاردۆ
        </h1>
      ...
      >
        {!isOpen ? (
          <p
            ...
            style={{ fontFamily: "var(--font-doran)", color: "#fdfaf2", textShadow: "0 2px 4px rgba(0,0,0,0.6)" }}
          >
            کلیک بکە بۆ کردنەوە
          </p>
        ) : (
